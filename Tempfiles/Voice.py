...
def listen():
    #if paused:  # check if the pause switch is enabled
     #   time.sleep(10)
...
def start_face_tracking_subprocess():
    ...
    subprocess_args = ["python", "face.py"]
    subprocess_obj = subprocess.Popen(subprocess_args)
